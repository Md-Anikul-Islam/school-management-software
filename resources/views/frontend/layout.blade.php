...
<head>
    ...
    <title>Home - An Education & Dry School Management service.</title>

    <link rel="shortcut icon" type="image/x-icon" href="{{URL::to('frontend/assets/images/favicon.png')}}" />
        ...
        <div class="header-content">
            ...
            <nav class="header-nav">
                <div class="header-nav-group">
                    <a href="index.html" class="header-nav-logo"><img
                            src="{{URL::to('frontend/assets/images/logo/logo.png')}}"
                            alt="logo"></a>
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-5">
                <div class="footer-about">
                    <p> iNiLabs International School IIS is a fully accredited, independent, international school in Dhaka,
                        Bangladesh. </p>
                    <ul>
                        <li>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <nav class="footer-navs">
                    ...
                    <a href="/notice-board.html">Notice</a>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="footer-social">
                    ...
                    <p>Copyright &copy; EduKing - School Management System</p>
                </div>
            </div>
        </div>
    </div>
