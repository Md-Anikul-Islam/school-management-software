            ...
            <div class="card-body">
                <form action="{{ route('candidate.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="student_registration_number" name="student_registration_number" required readonly>
                    </div>
                    <div class="mb-3">
                        <label for="class_id" class="form-label">Class</label>
                        <input type="text" class="form-control" id="class_id" name="class_id" required readonly>

                    </div>
                    <div class="mb-3">
                        <label for="section_id" class="form-label">Section</label>
                        <input type="text" class="form-control" id="section_id" name="section_id" required readonly>
                    </div>
                    <div class="mb-3">
                        <label for="application_verified_by" class="form-label">Application Verified By</label>
                        <input type="text" class="form-control" id="application_verified_by" name="application_verified_by" required>
                    </div>
                    <div class="mb-3">
                        <label for="date_of_verification" class="form-label">Date of Verification</label>
                        <input type="date" class="form-control" id="date_of_verification" name="date_of_verification" required>
                    </div>
