            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Add Asset Assignment</li>
                    </ol>
                </div>
                <h4 class="page-title">Add Asset Assignment</h4>
            </div>
        </div>
    </div>
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('asset-assignment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="assign_quantity" name="assign_quantity" required>
                    </div>
{{--                    <div class="mb-3">--}}
...
{{--                    </div>--}}
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control ck_editor" id="note" name="note" rows="3"></textarea>
                    </div>
