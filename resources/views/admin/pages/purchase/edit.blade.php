                ...
                <form action="{{ route('purchase.update', $purchase->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control select2" id="asset_id" name="asset_id" required>
                            ...
                            @foreach($assets as $asset)
                                <option value="{{ $asset->id }}" {{ $purchase->asset_id == $asset->id ? 'selected' : '' }}>{{ $asset->title }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control select2" id="purchase_by" name="purchase_by" required>
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" {{ $purchase->purchase_by == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control select2" id="unit" name="unit" required>
                            ...
                            <option value="KG" {{ $purchase->unit == 'KG' ? 'selected' : '' }}>KG</option>
                            <option value="Piece" {{ $purchase->unit == 'Piece' ? 'selected' : '' }}>Piece</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="purchase_price" class="form-label">Purchase Price</label>
                        <input type="number" class="form-control" id="purchase_price" name="purchase_price" step="0.01" value="{{ $purchase->purchase_price }}" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="service_date" name="service_date" value="{{ $purchase->service_date }}">
                    </div>
                    <div class="mb-3">
                        <label for="expire_date" class="form-label">Expire Date</label>
                        <input type="date" class="form-control" id="expire_date" name="expire_date" value="{{ $purchase->expire_date }}">
                    </div>
