            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Add Child Care</li>
                    </ol>
                </div>
                <h4 class="page-title">Add Child Care</h4>
            </div>
        </div>
    </div>
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('childcare.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" class="form-control" id="receive_time" name="receive_time" required>
                        @error('receive_time')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
